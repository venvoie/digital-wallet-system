...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card" style="max-width: 100%; margin-left: 0; margin-right: 0;">
        ...
        <div class="info-row">
            ...
            <div class="info-val mono"><asp:Label ID="lblAccountNumber" runat="server" Text="" /></div>
        </div>

        <%-- full name --%>
        <div class="info-row">
            <div class="info-key">Full Name</div>
            <div class="info-val"><asp:Label ID="lblFullName" runat="server" Text="" /></div>
        </div>

        <%-- username --%>
        <div class="info-row">
            <div class="info-key">Username</div>
            <div class="info-val"><asp:Label ID="lblUsername" runat="server" Text="" /></div>
        </div>

        <%-- email address --%>
        <div class="info-row">
            <div class="info-key">Email Address</div>
            <div class="info-val"><asp:Label ID="lblEmail" runat="server" Text="" /></div>
        </div>

        <%-- date registered --%>
        <div class="info-row">
            <div class="info-key">Date Registered</div>
            <div class="info-val"><asp:Label ID="lblDateRegistered" runat="server" Text="" /></div>
        </div>

        <%-- current balance — displayed in green --%>
        <div class="info-row">
        ...
        <%-- account status — rendered as active or inactive badge --%>
        <div class="info-row">
            <div class="info-key">Account Status</div>
            <div class="info-val"><asp:Label ID="lblStatus" runat="server" Text="" /></div>
        </div>
